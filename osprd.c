#include <linux/version.h>
	...
	*/
	...
	start_offset = (d->data) + (req->sector * SECTOR_SIZE);
	total_size = req->current_nr_sectors * SECTOR_SIZE; //calculate total size based on number of sectors requested
	...
	if((filp->f_flags & F_OSPRD_LOCKED) != 0) //locked
	{
		...
		{
			pid_list tail = NULL;
			pid_list head = d->read_locking_pids;
